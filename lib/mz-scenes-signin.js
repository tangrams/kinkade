///////////
// Login flow straight-up ganked from Tangram Play:
// https://github.com/tangrams/tangram-play/blob/master/src/js/user/sign-in-window.js
//
...
/////////////////
  ...
  return {
      ...
      closeSignInWindow: closeSignInWindow,
      signInStateReady: signInStateReady,
      cleanup: cleanup,
      pollWindowState: pollWindowState,
